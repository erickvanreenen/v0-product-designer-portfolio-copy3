              ...
              <form onSubmit={handleSubmit} className="space-y-7">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white border border-border text-foreground placeholder:text-foreground/25 focus:outline-none focus:border-[#09332C] transition-colors duration-200 text-sm"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-white border border-border text-foreground placeholder:text-foreground/25 focus:outline-none focus:border-[#09332C] transition-colors duration-200 resize-none text-sm"
                    placeholder="Tell me about your project or role."
                  />
                </div>
                <button
                  type="submit" disabled={isSubmitting}
                  className="px-6 py-3 bg-[#F0531C] text-white text-sm font-medium hover:bg-[#09332C] transition-colors duration-200 disabled:opacity-40 disabled:cursor-not-allowed"
                >
